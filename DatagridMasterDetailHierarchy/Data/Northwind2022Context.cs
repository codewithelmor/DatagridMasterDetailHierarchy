...
using DatagridMasterDetailHierarchy.Models;
using Microsoft.EntityFrameworkCore;

namespace DatagridMasterDetailHierarchy.Data;

public partial class Northwind2022Context : DbContext
{
    public Northwind2022Context()
    {
    }

    public Northwind2022Context(DbContextOptions<Northwind2022Context> options)
        : base(options)
    {
    }
